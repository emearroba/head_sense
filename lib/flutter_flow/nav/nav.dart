...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          ...
          path: DiaryCompletePageWidget.routePath,
          requireAuth: true,
          builder: (context, params) => DiaryCompletePageWidget(),
        ),
        FFRoute(
          name: BmiWidget.routeName,
          path: BmiWidget.routePath,
          builder: (context, params) => BmiWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: WeatherResultsWidget.routeName,
          path: WeatherResultsWidget.routePath,
          builder: (context, params) => WeatherResultsWidget(
            weatherData: params.getParam(
              'weatherData',
              ParamType.JSON,
            ),
          ),
        ...
        FFRoute(
          ...
          path: RemindersListWidget.routePath,
          builder: (context, params) => RemindersListWidget(),
        ),
        FFRoute(
          name: JoinStudyWidget.routeName,
          path: JoinStudyWidget.routePath,
          builder: (context, params) => JoinStudyWidget(),
        ),
        FFRoute(
            name: DailyDiaryPageWidget.routeName,
            path: DailyDiaryPageWidget.routePath,
            builder: (context, params) => params.isEmpty
                ? NavBarPage(initialPage: 'DailyDiaryPage')
                : NavBarPage(
                    initialPage: 'DailyDiaryPage',
                    page: DailyDiaryPageWidget(
        ...
        FFRoute(
          name: DiaryCompletePageRetryWidget.routeName,
          path: DiaryCompletePageRetryWidget.routePath,
          requireAuth: true,
          builder: (context, params) => DiaryCompletePageRetryWidget(),
        )
