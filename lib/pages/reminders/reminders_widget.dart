                      ...
                      Padding(
                        ...
                        child: StreamBuilder<List<RemindersRecord>>(
                          ...
                          builder: (context, snapshot) {
                            ...
                            List<RemindersRecord> containerRemindersRecordList =
                                snapshot.data!;
                            // Return an empty Container when the item does not exist.
                            if (snapshot.data!.isEmpty) {
                              return Container();
                            }
                            final containerRemindersRecord =
                                containerRemindersRecordList.isNotEmpty
                                    ? containerRemindersRecordList.first
                                    : null;
                                      ...
                                      children: [
                                        ...
                                        Switch(
                                          ...
                                          onChanged: (newValue) async {
                                            ...
                                            if (newValue!) {
                                              await containerRemindersRecord!
                                                  .reference
                                                  .update(
