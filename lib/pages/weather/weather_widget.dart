                    ...
                    child: Align(
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                          ...
                          _model.weatherResult = await WeatherrCall.call(
                            city: _model.cityTextController.text,
                          );

                          _shouldSetState = true;
                          if ((_model.weatherResult?.succeeded ?? true)) {
                            context.pushNamed(
                              WeatherResultsWidget.routeName,
                              queryParameters: {
                                'weatherData': serializeParam(
                                  getJsonField(
                                    (_model.weatherResult?.jsonBody ?? ''),
                                    r'''$''',
                                  ),
                                  ParamType.JSON,
                                ),
