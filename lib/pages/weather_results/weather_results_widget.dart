...
import 'weather_results_model.dart';
export 'weather_results_model.dart';

class WeatherResultsWidget extends StatefulWidget {
  const WeatherResultsWidget({
    super.key,
  ...
  static String routeName = 'weather_results';
  static String routePath = '/weatherResults';

  @override
  State<WeatherResultsWidget> createState() => _WeatherResultsWidgetState();
}

class _WeatherResultsWidgetState extends State<WeatherResultsWidget>
    with TickerProviderStateMixin {
  late WeatherResultsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => WeatherResultsModel());
