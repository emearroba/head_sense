...
class MetricCardWidget extends StatefulWidget {
  const MetricCardWidget({
    ...
    String? value,
    String? subLabel,
  })  : this.title = title ?? 'Total Headache Days',
        this.data = data ?? '18,12',
        this.labels = labels ?? 'Headache,Clear',
        this.colors = colors ?? 'primary,divider',
        this.value = value ?? '18',
        this.subLabel = subLabel ?? 'Days';
